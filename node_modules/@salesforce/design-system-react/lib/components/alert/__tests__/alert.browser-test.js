...
function (_Component) {
  ...
  _createClass(DemoComponent, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement("div", null, _react.default.createElement(_container.default, null, this.state.isOpen ? _react.default.createElement(_.default, {
...
describe('SLDSAlert: ', function () {
  ...
  describe('Dismiss alert', function () {
    ...
    it('calls onRequestClose handler', function () {
      ...
      (0, _chai.expect)(this.wrapper).to.have.state('isOpen', true);
      button.simulate('click', {});
      (0, _chai.expect)(this.wrapper).to.have.state('isOpen', false);
    });
  ...
  describe('Basic Alert Props Render', function () {
    ...
    it('render custom styles', function () {
      (0, _chai.expect)(this.wrapper.find('.slds-notify').prop('style').backgroundColor).to.equal('rgb(18, 49, 35)');
    });
  });
});