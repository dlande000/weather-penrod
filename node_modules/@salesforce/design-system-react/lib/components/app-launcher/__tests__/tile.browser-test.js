...
describe('SLDS APP LAUNCHER TILE *******************************************', function () {
  ...
  var createTile = function createTile(props) {
    return _react.default.createElement(_tile.default, (0, _lodash.default)({}, defaultTileProps, props));
  };
  ...
  function mountTile(props) {
    ...
    handles.tile = (0, _enzyme.mount)(_react.default.createElement(_iconSettings.default, {
  ...
  describe('Default App Launcher Tile', function () {
    ...
    it('search string highlights title', function () {
      ...
      [_react.default.createElement("span", null, "S"), _react.default.createElement("mark", null, "upport"), _react.default.createElement("span", null, " Cloud")])).to.be.true;
    });
    it('search string highlights description', function () {
      ...
      [_react.default.createElement("span", null, "Fluffy s"), _react.default.createElement("mark", null, "upport")])).to.be.true;
    });
  });
  ...
  describe('App Launcher Tile (icon node)', function () {
    var iconNode = _react.default.createElement(_icon.default, {
      name: "campaign",
      category: "standard",
      size: "large"
    });
