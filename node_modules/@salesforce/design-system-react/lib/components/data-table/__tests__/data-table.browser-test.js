...
var _rowActions = _interopRequireDefault(require("../../data-table/row-actions"));
...
var Simulate = _testUtils.default.Simulate,
    scryRenderedComponentsWithType = _testUtils.default.scryRenderedComponentsWithType,
...
describe('DataTable: ', function () {
  ...
  describe('Structure', function () {
    beforeEach(renderTable(_react.default.createElement(_dataTable.default, defaultProps, columns.map(function (columnProps) {
      return _react.default.createElement(_column.default, _extends({}, columnProps, {
    ...
    it('has checkboxes when selectRows is true or "checkbox"', function () {
      ...
      renderTable(_react.default.createElement(_dataTable.default, _extends({}, defaultProps, {
        selectRows: false
  ...
  describe('w/ RowActions', function () {
    ...
    it('renders the RowActions and uses dropdown override property', function () {
      renderTable(_react.default.createElement(_dataTable.default, defaultProps, columns.map(function (columnProps) {
        return _react.default.createElement(_column.default, _extends({}, columnProps, {
          key: columnProps.property
        }));
      }), _react.default.createElement(_rowActions.default, {
      ...
      var rowActionMenus = scryRenderedComponentsWithType(this.component, _rowActions.default);
    ...
    it('calls onAction & onSelect when an action is clicked', function (done) {
      ...
      var rowActionMenu = scryRenderedComponentsWithType(this.component, _rowActions.default)[0];
    ...
    it('Renders a fixedHeader table as expected', function () {
      renderTable(_react.default.createElement(_dataTable.default, _extends({}, defaultProps, {
        ...
        onFixedHeaderResize: function onFixedHeaderResize(event, data) {
          (0, _chai.expect)(Array.isArray(data.headerRefs)).to.eql(true);
          (0, _chai.expect)(data.headerRefs.length).to.eql(4);
          data.headerRefs.forEach(function (ref) {
            (0, _chai.expect)(_typeof(ref)).to.eql('object');
          });
          (0, _chai.expect)(_typeof(data.scrollerRef)).to.eql('object');
          (0, _chai.expect)(data.scrollerRef.className.search('slds-table_header-fixed_scroller') >= 0).to.eql(true);
        },
        onToggleFixedHeaderListeners: function onToggleFixedHeaderListeners(event, data) {
          (0, _chai.expect)(_typeof(data.attach)).to.eql('boolean');
          (0, _chai.expect)(_typeof(data.resizeHandler)).to.eql('function');
          (0, _chai.expect)(_typeof(data.scrollerRef)).to.eql('object');
          (0, _chai.expect)(data.scrollerRef.className.search('slds-table_header-fixed_scroller') >= 0).to.eql(true);
        },
        selectRows: "checkbox"
      ...
      (0, _chai.expect)(this.dom.querySelectorAll('.slds-table_header-fixed_container').length).to.eql(1);
      (0, _chai.expect)(this.dom.querySelectorAll('.slds-table_header-fixed_scroller').length).to.eql(1);
      (0, _chai.expect)(this.dom.querySelector('table.slds-table').className.search('slds-table_header-fixed') >= 0).to.eql(true);
      (0, _chai.expect)(this.dom.querySelectorAll('thead .slds-cell-fixed').length).to.eql(4);
    });
  });
});