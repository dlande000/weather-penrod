...
describe('SLDSModal: ', function () {
  ...
  _settings.default.setAppElement('#app');
  ...
  var renderModal = function renderModal(modalInstance) {
    ...
    var opener = _react.default.createElement("button", null, _react.default.createElement(_iconSettings.default, {
      iconPath: "/assets/icons"
    }, modalInstance));

    document.body.appendChild(container);
    renderedNode = _reactDom.default.render(opener, container);
    return renderedNode;
  };

  var createModal = function createModal(props) {
    return _react.default.createElement(_modal.default, (0, _lodash.default)({}, defaultProps, props));
  };
  ...
  describe('Open modal', function () {
    ...
    it('adds the large class', function () {
      (0, _chai.expect)(modal.className).to.include('slds-modal_large');
    });
  ...
  describe('Open with Prompt and Footer', function () {
    var modal;
    beforeEach(function () {
      var feet = _react.default.createElement("div", {
        className: "toes"
      }, "Toes");
    ...
    it('adds the footer', function () {
      ...
      (0, _chai.expect)(footer.className).to.include('slds-theme_default');
    });
    it('adds the prompt class', function () {
      (0, _chai.expect)(modal.className).to.include('slds-modal_prompt');
    });
    it('adds the prompt theme class', function () {
      (0, _chai.expect)(modal.querySelector('.slds-modal__header').className).to.include('slds-theme_warning');
    });
  ...
  describe('Open Directional', function () {
    ...
    beforeEach(function () {
      var feet = [_react.default.createElement("div", {
        key: "test-content1",
        className: "toes"
      }, "Toe 1"), _react.default.createElement("div", {
        key: "test-content2",
        className: "toes"
      }, "Toe 2")];
      getModal({
  ...
  describe('Keyboard behavior', function () {
    var modal;
    beforeEach(function () {
      var feet = [_react.default.createElement("button", {
        key: "test-content1",
        className: "cancel"
