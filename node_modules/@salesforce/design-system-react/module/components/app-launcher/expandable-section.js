...
import componentDoc from './docs.json'; // ## Children
...
function (_React$Component) {
  ...
  function AppLauncherExpandableSection() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AppLauncherExpandableSection)).call.apply(_getPrototypeOf2, [this].concat(args)));
