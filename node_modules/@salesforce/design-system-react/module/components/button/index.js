...
function (_React$Component) {
  ...
  function Button() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderButton", function () {
      ...
      }, ariaProps), _this.props.iconPosition === 'right' ? _this.renderLabel() : null, _this.props.iconName || _this.props.iconPath ? _this.renderIcon(_this.props.iconName) : null, _this.props.iconVariant === 'more' ? React.createElement(ButtonIcon, {
        category: "utility",
        name: "down",
        size: "x-small",
