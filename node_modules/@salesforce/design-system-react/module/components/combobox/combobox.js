  ...
  function Combobox(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPopover", function (_ref15) {
      ...
      return React.createElement("div", {
        ...
        ,
        "aria-owns": "".concat(_this.getId()) // eslint-disable-line jsx-a11y/aria-proptypes
        ,
        role: "combobox"
      }, React.createElement(Popover, popoverProps, React.createElement(InnerInput, {
        "aria-autocomplete": "none",
        "aria-controls": "".concat(_this.getId()),
        "aria-describedby": _this.getErrorId(),
        autoComplete: "off",
        className: "slds-combobox__input",
        containerProps: {
  ...
  _createClass(Combobox, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        label: labels.label,
        required: props.required
      }), this.props.fieldLevelHelpTooltip && hasRenderedLabel ? React.createElement(FieldLevelHelpTooltip, {
