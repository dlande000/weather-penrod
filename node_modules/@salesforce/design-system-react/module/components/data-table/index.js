...
import paletteColorsCommon from '../../utilities/design-tokens/dist/palette-colors.common'; // ## Children
...
function (_React$Component) {
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      }), React.createElement("tbody", null, numRows > 0 ? this.props.items.map(function (item) {
      ...
      if (this.props.fixedHeader) {
        component = React.createElement("div", {
          ...
          style: {
            borderTop: "1px solid ".concat(paletteColorsCommon.colorGray5),
            height: '100%'
          },
