...
function (_React$Component) {
  ...
  function Datepicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDatePicker", function (_ref) {
      ...
      var date = _this.state.formattedValue ? _this.parseDate(_this.state.formattedValue) : _this.state.value;
    ...
    _defineProperty(_assertThisInitialized(_this), "getDialog", function (_ref2) {
      ...
      return !_this.props.disabled && _this.getIsOpen() ? React.createElement(Dialog, {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function (_ref3) {
      ...
      var defaultInputProps = {
        iconRight: React.createElement(InputIcon // Remove || for assistiveText at next breaking change
        , {
          assistiveText: {
  ...
  _createClass(Datepicker, [{
    ...
    value: function render() {
      ...
      var inputToRender = this.props.children ? React.cloneElement(this.props.children, _objectSpread({}, inputProps)) : React.createElement(Input, inputProps);
