  ...
  _createClass(Trigger, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          openOn = _this$props.openOn,
          triggerRef = _this$props.triggerRef,
          triggerClassName = _this$props.triggerClassName,
          deprecatedPropsFromMenuDropdown = _objectWithoutProperties(_this$props, ["assistiveText", "children", "className", "id", "isInline", "isOpen", "onBlur", "menu", "onClick", "onFocus", "onKeyDown", "onMouseDown", "onMouseEnter", "onMouseLeave", "openOn", "triggerRef", "triggerClassName"]); // Trigger manipulation
