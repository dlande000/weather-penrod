...
function (_React$Component) {
  ...
  function MenuDropdown() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MenuDropdown)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "setCurrentSelectedIndices", function (nextProps) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMenuContent", function (customContent) {
      ...
      React.Children.forEach(customContent, function (child) {
        if (child && child.type.displayName === LIST) {
          ...
          var clonedCustomContent = React.cloneElement(child, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDialog", function (customContent, isOpen, outsideClickIgnoreClass) {
      ...
      return isOpen ? React.createElement(Dialog, {
        ...
        closeOnTabKey: true,
        contentsClassName: classNames('slds-dropdown', "slds-dropdown_".concat(_this.props.width), 'ignore-react-onclickoutside', _this.props.className, positionClassName),
  ...
  _createClass(MenuDropdown, [{
    ...
    value: function render() {
      ...
      */
      ...
      return React.createElement(CurrentTrigger, _extends({
        "aria-haspopup": true,
