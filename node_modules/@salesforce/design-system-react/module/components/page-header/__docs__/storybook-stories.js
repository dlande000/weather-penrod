...
var recordHomeActions = function recordHomeActions() {
  return React.createElement("div", null, React.createElement(SLDSButtonStateful, {
...
var relatedListControls = function relatedListControls() {
  return React.createElement(SLDSButtonGroup, null, React.createElement(SLDSButton, {
    label: "Add Contact",
    variant: "neutral"
  }), React.createElement(SLDSMenuDropdown, {
    assistiveText: {
