  ...
  describe('sort', function () {
    describe('direction', function () {
      it('should have a sort direction down icon', function () {
        expect(component.find('.slds-split-view__list-header svg > use').prop('xlinkHref')).to.have.string('arrowdown');
      });
      ...
      it('should have a sort direction up icon', function () {
        ...
        expect(component.find('.slds-split-view__list-header svg > use').prop('xlinkHref')).to.have.string('arrowup');
      });
