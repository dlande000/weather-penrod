...
function (_React$Component) {
  ...
  _createClass(SplitViewListbox, [{
    ...
    value: function componentWillMount() {
      ...
      this.ListItemWithContent = listItemWithContent(this.props.listItem || SplitViewListItemContent);
    }
  }, {
    ...
    value: function header() {
      return this.props.labels.header ? this.headerWrapper(React.createElement("span", null, React.createElement("span", {
