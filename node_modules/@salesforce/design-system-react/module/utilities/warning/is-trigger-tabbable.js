...
import { BUTTON, BUTTON_STATEFUL, BUTTON_GROUP, CHECKBOX, DATE_PICKER, INPUT, LOOKUP, TIME_PICKER } from '../../utilities/constants';
/* eslint-disable import/no-mutable-exports */
...
if (process.env.NODE_ENV !== 'production') {
  ...
  isTriggerTabbable = function isTriggerTabbable(COMPONENT, trigger, comment) {
    ...
    trigger.type.displayName !== BUTTON && trigger.type.displayName !== BUTTON_STATEFUL && trigger.type.displayName !== BUTTON_GROUP && trigger.type.displayName !== CHECKBOX && trigger.type.displayName !== DATE_PICKER && trigger.type.displayName !== INPUT && trigger.type.displayName !== LOOKUP && trigger.type.displayName !== TIME_PICKER) {
